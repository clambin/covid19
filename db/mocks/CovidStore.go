...
func (_m *CovidStore) CountEntriesByTime(from time.Time, to time.Time) ([]struct {
	Timestamp time.Time
	Count     int
}, error) {
	...
	if rf, ok := ret.Get(0).(func(time.Time, time.Time) []struct {
		Timestamp time.Time
		Count     int
	}); ok {
		r0 = rf(from, to)
...
func (_m *CovidStore) GetLatestForCountries() (map[string]models.CountryEntry, error) {
	...
	if rf, ok := ret.Get(0).(func() map[string]models.CountryEntry); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
// GetLatestForCountriesByTime provides a mock function with given fields: endTime
func (_m *CovidStore) GetLatestForCountriesByTime(endTime time.Time) (map[string]models.CountryEntry, error) {
	ret := _m.Called(endTime)

	var r0 map[string]models.CountryEntry
	if rf, ok := ret.Get(0).(func(time.Time) map[string]models.CountryEntry); ok {
		r0 = rf(endTime)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]models.CountryEntry)
...
type mockConstructorTestingTNewCovidStore interface {
	mock.TestingT
	Cleanup(func())
}

// NewCovidStore creates a new instance of CovidStore. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewCovidStore(t mockConstructorTestingTNewCovidStore) *CovidStore {
	mock := &CovidStore{}
	mock.Mock.Test(t)
