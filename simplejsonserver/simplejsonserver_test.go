...
func TestServer_Query(t *testing.T) {
	...
	var testCases = []struct {
		...
		{
			input:  `{"targets": [{"target": "country-confirmed","type": "table"}],"range": {"to": "2022-01-17T00:00:00Z"}}`,
			output: `[{"type":"table","columns":[{"text":"timestamp","type":"time"},{"text":"A","type":"number"},{"text":"B","type":"number"}],"rows":[["2022-01-19T00:00:00Z",4,10]]}]`,
		},
		{
			input:  `{"targets": [{"target": "country-deaths","type": "table"}],"range": {"to": "2022-01-17T00:00:00Z"}}`,
			output: `[{"type":"table","columns":[{"text":"timestamp","type":"time"},{"text":"A","type":"number"},{"text":"B","type":"number"}],"rows":[["2022-01-19T00:00:00Z",1,5]]}]`,
		},
		{
			input:  `{"targets": [{"target": "country-confirmed-population","type": "table"}],"range": {"to": "2022-01-17T00:00:00Z"}}`,
		...
		{
			input:  `{"targets": [{"target": "country-deaths-population","type": "table"}],"range": {"to": "2022-01-17T00:00:00Z"}}`,
		...
		},
		{
			...
			output: `[{"type":"table","columns":[{"text":"timestamp","type":"time"},{"text":"deaths","type":"number"},{"text":"confirmed","type":"number"}],"rows":[["2022-01-18T00:00:00Z",0,0],["2022-01-19T00:00:00Z",6,14]]}]`,
		},
		{
			input:  `{"targets": [{"target": "incremental","type": "table"}],"range": {"to": "2022-01-20T00:00:00Z"},"adhocFilters": [{"key": "Country Name","operator": "=","value": "A"}]}`,
			output: `[{"type":"table","columns":[{"text":"timestamp","type":"time"},{"text":"deaths","type":"number"},{"text":"confirmed","type":"number"}],"rows":[["2022-01-18T00:00:00Z",0,0],["2022-01-19T00:00:00Z",1,4]]}]`,
		},
		{
