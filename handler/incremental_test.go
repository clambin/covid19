...
func TestIncremental(t *testing.T) {
	...
	assert.Equal(t, grafanaJson.TableQueryResponseNumberColumn{1, 5, 7}, response.Columns[2].Data)
...
func TestIncrementalForCountry(t *testing.T) {
	...
	assert.Equal(t, grafanaJson.TableQueryResponseNumberColumn{1, 2}, response.Columns[2].Data)
